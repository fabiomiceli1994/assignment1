...
void Gauss_Seidel_test( unsigned int N, double lambda, double delta, SparseMatrix& A, const double tol, const int itCheck, const int MaxIter); //function for testing Gauss_Seidel
